 ...
 * The Nanocashcoin developers 2011-2017
 */
    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Nanocashcoin") + " - " + tr("Wallet"));
...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/nanocashcoin"));
    setWindowIcon(QIcon(":icons/nanocashcoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Nanocashcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/nanocashcoin"), tr("&About Nanocashcoin"), this);
    aboutAction->setStatusTip(tr("Show information about Nanocashcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Nanocashcoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/nanocashcoin"), tr("&Show / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Nanocashcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Nanocashcoin addresses"));

    openRPCConsoleAction = new QAction(QIcon(":/icons/debugwindow"), tr("&Debug window"), this);
    openRPCConsoleAction->setStatusTip(tr("Open debugging and diagnostic console"));

    openChatroomAction = new QAction(QIcon(":/icons/nanocashcoin"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open https://nanocashcoin.chat in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/nanocashcoin"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.nanocashcoin.net in a web browser."));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/nanocashcoin_testnet"));
            setWindowIcon(QIcon(":icons/nanocashcoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/nanocashcoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Nanocashcoin client"));
...
void BitcoinGUI::openChatroom() {
    QDesktopServices::openUrl(QUrl("https://nanocashcoin.chat"));
}

void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.nanocashcoin.net"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nanocashcoin network", "", count));
}
...
{
    QString strTitle = tr("Nanocashcoin"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Nanocashcoin address or malformed URI parameters."),
