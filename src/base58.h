 ...
 * nccoin public-key-hash-addresses have version 55 (or 111 testnet).
...
public:
    enum
    {
        PUBKEY_ADDRESS = 53,  // nccoin: addresses begin with 'N'
        SCRIPT_ADDRESS = 113, // nccoin: addresses begin with 'n'
