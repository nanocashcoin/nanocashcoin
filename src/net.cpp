...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("nanocashcoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nanocashcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed0", "seed0.nanocashcoin.tech"},
    {"seed1", "seed1.nanocashcoin.tech"},
    {"seed2", "seed2.nanocashcoin.tech"},
    {"seed3", "seed3.nanocashcoin.tech"},
    {"seed4", "seed4.nanocashcoin.tech"},
    {"seed5", "seed5.nanocashcoin.tech"},
    {"seed6", "seed6.nanocashcoin.tech"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    //{"tseednanocashcoin", "tseed.nanocashcoin.tech"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nanocashcoin is probably already running."), addrBind.ToString().c_str());
        else
