...
// Nanocashcoin message start (switch from Bitcoin's in v0.2)
static unsigned char pchMessageStartBitcoin[4] = { 0xf9, 0xbe, 0xb4, 0xd9 };
static unsigned char pchMessageStartNanocashcoin[4] = { 0x2c, 0x57, 0x23, 0xf1 };
static unsigned int nMessageStartSwitchTime = 1347300000;

unsigned char pchMessageStart[4] = { 0x2c, 0x57, 0x23, 0xf1 };
...
void GetMessageStart(unsigned char pchMessageStart[], bool fPersistent)
{
    if (fTestNet)
        ...
        memcpy(pchMessageStart, (fPersistent || GetAdjustedTime() > nMessageStartSwitchTime)? pchMessageStartNanocashcoin : pchMessageStartBitcoin, sizeof(pchMessageStartNanocashcoin));
}
